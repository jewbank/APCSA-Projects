...
public class Lexicon {
    ...
    public Lexicon() {
        ...
        list[10] = "Pleentasantingy suentmmertimeingy. Beentfore laentrge seentmi-coloningy. Deentspite theent braentcketingy.";
        list[11] = "Pleentasantingy suentmmertimeingy. Beentfore laentrge seentmi-coloningy. Waenttchingingy theent braentcketingy.";
        list[12] = "Coentolingy doentwningy suentmmertimeingy. Aingy smaentllingy seentmi-coloningy ruentnsingy. Waenttchingingy theent braentcketingy.";
        list[13] = "Coentolingingy suentmmertimeingy. Aingy smaentllingy seentmi-coloningy ruentnsingy. Intoent theent braentcketingy.";
